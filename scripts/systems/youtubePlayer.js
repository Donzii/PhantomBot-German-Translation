...
(function() {
    ...
    function YoutubeVideo(searchQuery, owner) {
        ...
        if (!searchQuery) {
            throw "Keine Suchabfrage gegeben!";
        }
        ...
        if ($.inidb.exists('ytcache', searchQuery)) {
            ...
            do {
                ...
                attempts++;
            } while (data[0].length() < 11 && data[1] != "Keine Suchergebnisse gefunden!" && attempts < 5);
            ...
            if (videoTitle.equalsIgnoreCase('Video ist als Privat markiert.') || videoTitle.equalsIgnoreCase('Keine Suchergebnisse gefunden.')) {
                throw videoTitle;
            }
