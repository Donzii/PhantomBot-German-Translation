(function() {
    ...
    $.bind('PubSubModerationUnTimeout', function(event) {
        ...
        $.discordAPI.sendMessageEmbed(modLogChannel, 'green', '**Auszeit entfernt von:** ' + '[' + username + '](https://twitch.tv/' + username.toLowerCase() + ')' + ' \r\n\r\n **Ersteller:** ' + creator);
    });
    ...
    $.bind('PubSubModerationUnBan', function(event) {
        ...
        $.discordAPI.sendMessageEmbed(modLogChannel, 'green', '**Bann entfernt von:** ' + '[' + username + '](https://twitch.tv/' + username.toLowerCase() + ')' + ' \r\n\r\n **Ersteller:** ' + creator);
    });
