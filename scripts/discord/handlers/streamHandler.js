...
(function() {
    var onlineToggle = $.getSetIniDbBoolean('discordSettings', 'onlineToggle', false),
        onlineMessage = $.getSetIniDbString('discordSettings', 'onlineMessage', '(name) ist gerade auf Twitch online gegangen!'),
        ...
        gameMessage = $.getSetIniDbString('discordSettings', 'gameMessage', '(name) hat gerade das Spiel auf Twitch geändert!'),
    ...
    $.bind('webPanelSocketUpdate', function(event) {
        if (event.getScript().equalsIgnoreCase('./discord/handlers/streamHandler.js')) {
            ...
            onlineMessage = $.getIniDbString('discordSettings', 'onlineMessage', '(name) ist gerade auf Twitch online gegangen!');
            ...
            gameMessage = $.getIniDbString('discordSettings', 'gameMessage', '(name) hat gerade das Spiel auf Twitch geändert!');
